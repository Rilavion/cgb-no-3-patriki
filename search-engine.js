...
window.CGB_SEARCH=(function(){
  ...
  const STATIC=[
    ...
    {group:"Страницы",title:"Учебные материалы",hint:"Курсы и уроки для сотрудников",href:"learn.html",kw:"обучение курсы уроки тренировка материалы учёба"},
    ...
    {group:"Заявления и формы",title:"Тесты",hint:"Проверка знаний сотрудников",href:"tests.html",kw:"тесты экзамен аттестация проверка знаний"},
    {group:"Заявления и формы",title:"Заявление на отпуск",hint:"Подача заявления на отпуск",href:"leave.html",kw:"отпуск заявление отгул отдых"},
    {group:"Заявления и формы",title:"Отпуск IC",hint:"Заявление на отпуск (IC)",href:"vacation-ic.html",kw:"отпуск ic заявление"},
    {group:"Заявления и формы",title:"Отпуск OOC",hint:"Заявление на отпуск (OOC)",href:"vacation-ooc.html",kw:"отпуск ooc заявление"},
    {group:"Заявления и формы",title:"Увольнение",hint:"Заявление на увольнение",href:"dismissal.html",kw:"увольнение заявление уволиться сокращение"},
    {group:"Заявления и формы",title:"Повышение",hint:"Заявление на повышение",href:"promotion.html",kw:"повышение разжалование карьера должность"},
    ...
    {group:"Заявления и формы",title:"Отчёт",hint:"Еженедельный отчёт сотрудника",href:"report.html",kw:"отчёт отчет еженедельный работа"},
    {group:"Заявления и формы",title:"Запрос проверки АБ",hint:"Заявка на проверку Администрации Больницы",href:"vp-request.html",kw:"проверка аб запрос вп заявка"},
    {group:"Администрирование",title:"Личный кабинет",hint:"Профиль и настройки",href:"lk.html",kw:"личный кабинет профиль настройки роль"},
    {group:"Администрирование",title:"Входящие заявления",hint:"Обработка заявлений с Discord",href:"apps.html",kw:"заявления входящие обработка бот"},
    {group:"Администрирование",title:"Статистика заявлений",hint:"Цифры по заявлениям",href:"apps-stats.html",kw:"статистика заявления цифры"},
    {group:"Администрирование",title:"Конструктор документов",hint:"Приказы и рапорта",href:"docs.html",kw:"документы конструктор приказ рапорт шаблон"},
    ...
    {group:"Администрирование",title:"Проверки АБ",hint:"Проверки Администрации Больницы",href:"vp.html",kw:"проверки аб администрация контроль"},
    {group:"Администрирование",title:"Роли и доступы",hint:"Управление ролями",href:"roles.html",kw:"роли доступы права админ"},
    {group:"Администрирование",title:"Зарплатная ведомость",hint:"Выплаты сотрудникам",href:"payroll.html",kw:"зарплата ведомость выплаты деньги"},
    {group:"Администрирование",title:"Поставки",hint:"Заявки на поставки",href:"supply.html",kw:"поставки заявки склад медикаменты"}
  ];
  ...
  return {build,invalidate,STATIC,parseNick};
})();
